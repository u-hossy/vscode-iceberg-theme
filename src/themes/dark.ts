...
export function create(palette: VscodePalette): VscodeTheme {
	...
	return {
		...
		colors: {
			...
			'button.background': p.editor.fg.darken(0.125),
			'button.foreground': p.editor.bg,
			'button.hoverBackground': p.ansi.brightWhite.darken(0.125),
			...
			'tab.activeModifiedBorder': p.colors.lblue,
			...
			'terminalCommandDecoration.defaultBackground': p.tokens.comment,
			'terminalCommandDecoration.errorBackground': p.colors.red,
			'terminalCommandDecoration.successBackground': p.colors.blue,
